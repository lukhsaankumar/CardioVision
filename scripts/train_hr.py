...
def train_hr(records, threshold=160,
             model_path='../CardioVision/models/hr_model.json'):
    ...
    np.save('../CardioVision/models/hr_values_train.npy', all_hr)
    np.save('../CardioVision/models/hr_labels_train.npy', hr_labels)
